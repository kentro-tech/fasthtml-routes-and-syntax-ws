"""
Global app instance and shared resources.
Contains the Air app instance and database operations shared across all modules.
"""
...
# Global app instance - shared across all modules
app = air.Air()
