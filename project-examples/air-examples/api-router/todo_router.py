"""
Todo-related routes using FastAPI's APIRouter.
Handles all todo management functionality for projects.
"""

import air
from fastapi import APIRouter, Form
from datetime import date, datetime
from db import get_project, get_todos, get_todo, create_todo, update_todo, delete_todo
    ...
    return air.Html(
        air.Head(
            ...
            air.Style("""
                ...
                .router-info { background: #e8f5e8; padding: 10px; border-radius: 5px; margin-bottom: 20px; }
            """)
        ),
        air.Body(
            ...
            air.Div(
                air.P("🔀 Todo routes handled by todo_router.py"),
                class_="router-info"
            ),
